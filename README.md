...
* **সমাধান:** Developer পোর্টালে Webhooks সেকশনে গিয়ে ড্রপডাউন থেকে আপনার পেজটি সিলেক্ট করে **"Subscribe"** এ ক্লিক করুন। অ্যাপটি "Development Mode"-এ থাকলে শুধুমাত্র আপনার ডেভেলপার আইডি থেকেই মেসেজ দিন। 

### ৫. OpenRouter Rate Limit Error (`429 Error`)
* **কারণ:** ফ্রি মডেলগুলোতে অনেক সময় গুগলের সার্ভার ওভারলোড থাকে। 
